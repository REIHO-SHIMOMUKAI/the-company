        ...
        <div class="container">
            ...
            <div class="navbar-nav">
                ...
                <form action="../actions/logout.php" method="post" class="d-flex ms-2">
                    ...
                    <!-- d-flexはblockなので、本来違う行になってしまうが、d-flexを使うとﾌﾚｷｼﾌﾞﾙなデザインができる。d-inlineでもいいが、不自然になる。flexはautoみたいなもの。 -->
                </form>
            </div>
        </div>
    </nav>
            ...
            <table class="table table-hover align-middle">
                ...
                <tbody>
                    ...
                    while($user = $all_users->fetch_assoc()) {
                        //fetch_assocでは、sqlのSELECTでとってきたデータをassociative arrayとして保存する
                        //Loop1: $user = ['id'=> '1', 'first_name'=>'Mary','last_name'=>'Watson,...']
                        //loopごとに次の行に変わる
                        ?>
                        ...
                        ?>
                            <i class="fa-solid fa-user text-secondary d-block text-center dashboard-icon"></i>
                                <!-- dashboard-iconはstyle.cssで定義している -->
                        <?php
                        }
                        ?>
